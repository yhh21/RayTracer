...
{
    const Float invBase = FLOAT_1 / static_cast<Float>(base);
    uint64_t reversedDigits = 0;
    Float invBaseN = FLOAT_1;
    while (a)
    {
    ...
    CHECK_LT(reversedDigits * invBaseN, static_cast<Float>(1.00001F));
    return (std::min)(reversedDigits * invBaseN, common::math::ONE_MINUS_MACHINE_EPSILON);
}
...
static Float ScrambledRadicalInverseSpecialized(const uint16_t *perm, uint64_t a)
{
    ...
    CHECK_LT(invBaseN * (reversedDigits + invBase * perm[0] / (1 - invBase)), static_cast<Float>(1.00001F));
    return (std::min)(invBaseN * (reversedDigits + invBase * perm[0] / (1 - invBase)),
        common::math::ONE_MINUS_MACHINE_EPSILON);
}
...
Float RadicalInverse(int baseIndex, uint64_t a)
{
    ...
    {
    case 0:
        return ReverseBits64(a) * static_cast<Float>(0x1p-64);
    case 1:
    ...
    default:
        /* TODO
        LOG(FATAL) << StringPrintf("Base %d is >= 1024, the limit of core::sampler::RadicalInverse",
            baseIndex);
        */
        return 0;
    }
