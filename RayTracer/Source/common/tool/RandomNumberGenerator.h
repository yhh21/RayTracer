...
public:
    ...
    RandomNumberGenerator() : state(PCG32_DEFAULT_STATE), inc(PCG32_DEFAULT_STREAM)
    {}

    RandomNumberGenerator(uint64_t sequenceIndex)
    {
    ...
    Float UniformFloat()
    {
        return (std::min)(math::ONE_MINUS_MACHINE_EPSILON, static_cast<Float>(UniformUInt32() * 0x1p-32f));
    }
    ...
    int64_t operator-(const RandomNumberGenerator &other) const
    {
